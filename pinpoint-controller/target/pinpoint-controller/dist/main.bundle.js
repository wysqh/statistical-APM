...
var NB_CORE_PROVIDERS = __WEBPACK_IMPORTED_MODULE_4__data_data_module__["a" /* DataModule */].forRoot().providers.concat(__WEBPACK_IMPORTED_MODULE_2__nebular_auth__["d" /* NbAuthModule */].forRoot({
    providers: {
        email: {
            service: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["f" /* NbDummyAuthProvider */],
            config: {
                delay: 3000,
                login: {
                    rememberMe: true,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__nebular_auth__ = __webpack_require__("../../../../@nebular/auth/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'login',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["h" /* NbLoginComponent */],
            },
            {
                path: 'register',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["j" /* NbRegisterComponent */],
            },
            {
                path: 'logout',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["i" /* NbLogoutComponent */],
            },
            {
                path: 'request-password',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["k" /* NbRequestPasswordComponent */],
            },
            {
                path: 'reset-password',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["l" /* NbResetPasswordComponent */],
            },
        ],
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__nebular_auth__ = __webpack_require__("../../../../@nebular/auth/index.js");
        ...
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__nebular_auth__["d" /* NbAuthModule */].forRoot({
                    providers: {
                        email: {
                            service: __WEBPACK_IMPORTED_MODULE_10__nebular_auth__["g" /* NbEmailPassAuthProvider */],
                            config: {
                                baseEndpoint: '',
                                login: {
                                    alwaysFail: false,
            ...
            providers: [
                ...
                { provide: __WEBPACK_IMPORTED_MODULE_10__nebular_auth__["a" /* NB_AUTH_TOKEN_WRAPPER_TOKEN */], useClass: __WEBPACK_IMPORTED_MODULE_10__nebular_auth__["c" /* NbAuthJWTToken */] },
