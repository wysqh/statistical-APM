...
/***/ "../../../../../src/app/@core/data/user-info.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
module.exports = "<div class=\"header-container\"\r\n     [class.left]=\"position === 'normal'\"\r\n     [class.right]=\"position === 'inverse'\">\r\n  <div class=\"logo-containter\">\r\n    <a (click)=\"toggleSidebar()\" href=\"#\" class=\"navigation\"><i class=\"nb-menu\"></i></a>\r\n    <div class=\"logo\" (click)=\"goToHome()\">KongMing Data Analysis Platform<span style=\"font-size: xx-small\">|Gu Tiankai</span></div>\r\n  </div>\r\n  <ngx-theme-switcher></ngx-theme-switcher>\r\n</div>\r\n\r\n<nb-actions\r\n  size=\"medium\"\r\n  class=\"header-container\"\r\n  [class.right]=\"position === 'normal'\"\r\n  [class.left]=\"position === 'inverse'\">\r\n  <nb-action icon=\"nb-grid-b\" class=\"toggle-layout\" (click)=\"toggleSettings()\"></nb-action>\r\n  <nb-action>\r\n    <nb-user (menuClick)=\"menuClick($event)\" [menu]=\"userMenu\" [name]=\"user?.name\" [picture]=\"user?.picture\"></nb-user>\r\n  </nb-action>\r\n  <nb-action class=\"control-item\" disabled icon=\"nb-notifications\"></nb-action>\r\n  <nb-action class=\"control-item\" icon=\"nb-email\"></nb-action>\r\n  <nb-action class=\"control-item\">\r\n    <nb-search type=\"rotate-layout\" (click)=\"startSearch()\"></nb-search>\r\n  </nb-action>\r\n</nb-actions>\r\n"
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(sidebarService, menuService, userService, analyticsService, authService, userInfo) {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.authService.onTokenChange()
            ...
            if (token.getValue()) {
                ...
                _this.userInfo.setUserInfo(token.getPayload().name); // 用户信息DI注入
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__core_data_user_info_service__ = __webpack_require__("../../../../../src/app/@core/data/user-info.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NB_THEME_PROVIDERS = __WEBPACK_IMPORTED_MODULE_4__nebular_theme__["n" /* NbThemeModule */].forRoot({
    ...
    __WEBPACK_IMPORTED_MODULE_10__core_data_user_info_service__["a" /* UserInfoService */],
]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__core_data_user_info_service__ = __webpack_require__("../../../../../src/app/@core/data/user-info.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_13__core_data_user_info_service__["a" /* UserInfoService */],
            ],
        })
    ], AppModule);
    return AppModule;
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function () {
        ...
        return this.authService.isAuthenticated()
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["e" /* tap */])(function (authenticated) {
            if (!authenticated) {
