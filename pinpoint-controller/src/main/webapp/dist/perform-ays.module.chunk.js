...
module.exports = "<nb-card>\n  <nb-card-header>Max Request</nb-card-header>\n  <nb-card-body>\n<h1>昨日请求数TOP10</h1>\n<table datatable [dtOptions]=\"dtOptions\" [dtTrigger]=\"dtTrigger\" class=\"row-border hover\">\n  <thead>\n  <tr>\n    <th>模块名称</th>\n    <th>接口</th>\n    <th>请求数</th>\n    <th>详情传送门</th>\n  </tr>\n  </thead>\n  <tbody>\n  <tr *ngFor=\"let element of baseResult.data\">\n    <td> {{ element.appName }} </td>\n    <td> {{ element.uri }} </td>\n    <td> {{ element.requests }} </td>\n    <td>\n      <a routerLink={{element.linkage}} [queryParams]=\"{'appName':element.appName,\n                                                      'uri': element.uri}\">传送门</a>\n    </td>\n  </tr>\n  </tbody>\n</table>\n  </nb-card-body>\n</nb-card>\n"
...
module.exports = "<nb-card>\n  <nb-card-header>Max Response</nb-card-header>\n  <nb-card-body>\n<h1>昨日最大耗时TOP10</h1>\n<table datatable [dtOptions]=\"dtOptions\" [dtTrigger]=\"dtTrigger\" class=\"row-border hover\">\n  <thead>\n  <tr>\n    <th>模块名称</th>\n    <th>接口</th>\n    <th>最大响应时间(ms)</th>\n    <th>详情传送门</th>\n  </tr>\n  </thead>\n  <tbody>\n  <tr *ngFor=\"let element of baseResult.data\">\n    <td> {{ element.appName }} </td>\n    <td> {{ element.uri }} </td>\n    <td> {{ element.maxRsp }} </td>\n    <td>\n      <a routerLink={{element.linkage}} [queryParams]=\"{'appName':element.appName,\n                                                      'uri': element.uri}\">传送门</a>\n    </td>\n  </tr>\n  </tbody>\n</table>\n  </nb-card-body>\n</nb-card>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ui_features_ui_features_module__ = __webpack_require__("../../../../../src/app/pages/ui-features/ui-features.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__theme_theme_module__ = __webpack_require__("../../../../../src/app/@theme/theme.module.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    PerformAysModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_17__theme_theme_module__["a" /* ThemeModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_16__ui_features_ui_features_module__["UiFeaturesModule"],
            ],
