      ...
      .pipe(
        ...
        map((res: HttpResponse<AuthResponse>) => {
          ...
          return new NbAuthResult(
            ...
            res,
            res.body.success ?
              this.getConfigValue('login.redirect.success') : this.getConfigValue('login.redirect.failure'),
            res.body.errors,
            res.body.messages ? res.body.messages : this.getConfigValue('messages.getter')('login', res),
            res.body.token ? res.body.token : this.getConfigValue('token.getter')('login', res));
        }),
        catchError((res) => {
