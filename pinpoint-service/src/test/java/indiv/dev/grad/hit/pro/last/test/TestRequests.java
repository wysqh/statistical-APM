...
public class TestRequests {
    public static void main(String[] args) {
        ...
        List<AppUriEffectiveDaily> appUriEffectiveDailyList = appUriEffectiveDailyMapper.selectRequestByDate(iDate);
        System.out.println(appUriEffectiveDailyList.size());
        for (AppUriEffectiveDaily appUriEffectiveDaily: appUriEffectiveDailyList) {
            System.out.println(appUriEffectiveDaily.getAppName() + " " +
